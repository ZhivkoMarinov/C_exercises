...
void setDataEmployee(struct employee *, struct boss*, int);
 
void setDataBoss(struct boss *);
...
int main()
{
    ...
    struct employee newEmployee[10];
    struct boss newBoss[10];
    ...
    for (int i = 0; i < ARRAY_SIZE(newEmployee); i++){
...
void setDataEmployee(struct employee *ptr, struct boss *boss_ptr, int id_num){
...
void setDataBoss(struct boss *ptr){
